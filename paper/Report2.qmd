...
subtitle: "Technical Report - Andreas Meid - SS2021"
output:
  html_document:
    code_folding: show
    includes:
...
<img width="700" style="float: center" src="../results/P1.PNG"/>


### P2

<img width="700" style="float: center" src="../results/P2.PNG"/>
...
```{r generateBibliography, results="asis", echo=FALSE, eval=FALSE}
